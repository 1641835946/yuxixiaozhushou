...
package com.liangjie.yuxixiaozhushou.Sandwich.wizard.model;

import android.support.v4.app.Fragment;
import android.text.TextUtils;

import com.liangjie.yuxixiaozhushou.Sandwich.wizard.ui.SingleChoiceFragment;
...
public class BranchPage extends SingleFixedChoicePage {
    public List<Branch> mBranches = new ArrayList<Branch>();
    ...
    public BranchPage addBranch(String choice, PageList childPageList) {
        for (Page page : childPageList) {
            page.setParentKey(choice);
        }
        mBranches.add(new Branch(choice, childPageList));
