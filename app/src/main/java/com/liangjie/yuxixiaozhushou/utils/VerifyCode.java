package com.liangjie.yuxixiaozhushou.utils;
...
//        int count=6;
        ...
        for (int i=0;i<count;i++){
            ...
            switch (index){
                ...
                case R.styleable.VerifyCode_codeLength:
                    ...
                    Log.e("梁洁", "code lenght is " + mCodeText);
                    break;
                ...
                case R.styleable.VerifyCode_pointNum:
                    ...
                    Log.e("梁洁", "mPointNum is " + mPointNum);
                    break;
    ...
    private void initData(){
        ...
        Log.e("梁洁", "code text is " + mCodeText);
        mPaint=new Paint();
...
// UNSPECIFIED：表示子布局想要多大就多大，很少使用
    ...
    public String getValidationCode(int length,boolean contains) {
        Log.e("梁洁", "length is " + length);
        Log.e("梁洁", "is contains: " + contains);
        String val = "";
