 ...
 */
package com.liangjie.yuxixiaozhushou.waterdroplistview;
...
import com.liangjie.yuxixiaozhushou.waterdroplistview.WaterDropListViewFooter;
import com.liangjie.yuxixiaozhushou.waterdroplistview.WaterDropListViewHeader;
...
//	private int mReadyHeight; // view由stretch变成ready的高度
	...
	public void needFooter(int size, ListAdapter adapter) {
		if (size>10) {
